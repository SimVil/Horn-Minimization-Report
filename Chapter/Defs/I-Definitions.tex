...
provided new structure known as \belemp{FD-Graph} and algorithm to represent 
...
\begin{definition}[Minimality] $\I$ is \belemp{minimum} if there is no 
...
not too heavy. It is sometimes called \belemp{Hasse diagram} (see 
