...
\subfloat[Average time (in $s$), $|\Sg| = 100$]{
	\hspace{-4em}
	\scalebox{0.48}{\input{Pictures/III/Berczi/Operators_SgFixed.pgf}}
}
...
\subfloat[Some landmarks times]{
	\begin{tabular}{| c || c | c |}
		...
		5000  & 20.478  & 0.617 \\ \hline
		10000 & 54.774  & 1.659 \\ \hline
		15000 & 101.242 & 2.967 \\ \hline 
		20000 & 248.493 & 8.053 \\ \hline 
	\end{tabular}
}\qquad
\subfloat[Some landmarks times]{
	\begin{tabular}{| c || c | c |}
